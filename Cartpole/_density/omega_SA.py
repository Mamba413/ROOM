...
class VisitationRatioModel_init_SA():
    ...
    def __init__(self, replay_buffer, 
        ...
        self.optimizer = tf.keras.optimizers.Adam(tf.keras.optimizers.schedules.InverseTimeDecay(lr, decay_steps = 100, decay_rate = 0.99), clipnorm = w_clipping_norm, clipvalue = w_clipping_val)
        ...
        with tf.device('/gpu:' + str(self.gpu_number)):
            ...
            for i in range(rep):
                ...
                if self.sepe_A:
                    ...
                    median_AA = tf.cast(median_AA, tf.float64)
